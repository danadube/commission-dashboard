/**
 * Google Sheets Service - Serverless Version
 * Uses Vercel serverless function to handle OAuth (bypasses COOP)
 */
...
export async function initialize() {
  console.log('🚀 Initializing Google Sheets integration (Serverless OAuth)...');
...
/**
 * Sign in the user using serverless OAuth
 */
export async function signIn() {
  console.log('🔐 Requesting OAuth URL from serverless function...');
  
  try {
    // Call the serverless function to get the auth URL
    const response = await fetch('/api/auth/google?action=authorize');
    ...
    // Redirect to Google OAuth (handled by serverless function)
